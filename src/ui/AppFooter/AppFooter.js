...
import {faEnvelope, faPhone, faLock, faFileInvoice, faTruck, faUndo, faCheck,faCopyright} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        ...
        <footer className={Style.Footer}>
            ...
            <section className={Style.FooterFeature}>
                ...
                <span>
                    <FontAwesomeIcon icon={faCopyright} className={Style.FooterIcon} size="lg"/>
                    <p>2020 Shopper's Car All rights reserved.</p>
                </span>
